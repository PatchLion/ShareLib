...
{ 
	...
	m_pFBShare = new CFacebookShare("XXXXXXXXXXXXXXXX",  this);
	...
	m_pFlickrShare = new CFlickrShare("XXXXXXXXXXXXXXX",  "XXXXXXXXXXXXXXXXXXXXXXXXXXXX",  this);
	...
	m_pTwitterShare = new CTwitterShare("XXXXXXXXXXXXXXXXXX", "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", this);

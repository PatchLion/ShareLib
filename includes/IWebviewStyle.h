...
public:
	IWebviewStyle()
	{
		...
		setStatePixmap(ShareLibrary::ShowDefault, QPixmap(":/images/waiting.png"));
		setStatePixmap(ShareLibrary::ShowFailed, QPixmap(":/images/failed.png"));
		setStatePixmap(ShareLibrary::ShowProcess, QPixmap(":/images/waiting.png"));
		setStatePixmap(ShareLibrary::ShowSuccess, QPixmap(":/images/success.png"));
